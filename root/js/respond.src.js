...
<html lang="en">
  ...
  <link rel="web-socket" href="wss://live.github.com/_sockets/VjI6MTU3MjA1MjcwOmQ3ZWYwZTVkMGY3MjhjYTM5ZDFhYmMwZjljYmQzZGQ5OTkxNzk2N2I5YTVlNDIxZWUwNjY5NTI4MzhlY2E3ZWU=--a9390065ab767ef5c26adb0e3b9dfd76b1578924">
  <meta name="pjax-timeout" content="1000">
  <link rel="sudo-modal" href="/sessions/sudo_modal">
  <meta name="request-id" content="C1F9:3888:16E1E12:25768AD:58CEB2A2" data-pjax-transient>
...
<meta content="collector.githubapp.com" name="octolytics-host" /><meta content="github" name="octolytics-app-id" /><meta content="https://collector.githubapp.com/github-external/browser_event" name="octolytics-event-url" /><meta content="C1F9:3888:16E1E12:25768AD:58CEB2A2" name="octolytics-dimension-request_id" /><meta content="26076924" name="octolytics-actor-id" /><meta content="PatrickA7" name="octolytics-actor-login" /><meta content="1204dcba0fbd0fca0af1f1a1596c017271eaef05c6a962aebeb83483c9f2be20" name="octolytics-actor-hash" />
<meta content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" name="analytics-location" />
  ...
  <meta name="user-login" content="PatrickA7">

      <meta name="expected-hostname" content="github.com">
    <meta name="js-proxy-site-detection-payload" content="OTlmMzc2MTE0ODU1NTY3NDQ1OWYzYmE4YTc1ZDg3NTI4NDNiMjY4YWU5YzA0MDRmOGExYjAzODFmNWZmZTgxZHx7InJlbW90ZV9hZGRyZXNzIjoiNDIuMjQxLjY3LjMyIiwicmVxdWVzdF9pZCI6IkMxRjk6Mzg4ODoxNkUxRTEyOjI1NzY4QUQ6NThDRUIyQTIiLCJ0aW1lc3RhbXAiOjE0ODk5NDExNTUsImhvc3QiOiJnaXRodWIuY29tIn0=">


  <meta name="html-safe-nonce" content="fddda3fe3bd531ef0054cddde1cac02dfd56fab7">
...
<a class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, create new gist">
  ...
  <li class="header-nav-item dropdown js-menu-container">
    <a class="header-nav-link name tooltipped tooltipped-sw js-menu-target" href="/PatrickA7"
       aria-label="View profile and more"
       data-ga-click="Header, show menu, icon:avatar">
      <img alt="@PatrickA7" class="avatar" src="https://avatars2.githubusercontent.com/u/26076924?v=3&amp;s=40" height="20" width="20">
      <span class="dropdown-caret"></span>
    </a>
    ...
    <div class="dropdown-menu-content js-menu-content">
      <div class="dropdown-menu dropdown-menu-sw">
        <div class="dropdown-header header-nav-current-user css-truncate">
          Signed in as <strong class="css-truncate-target">PatrickA7</strong>
        </div>

        <div class="dropdown-divider"></div>

        <a class="dropdown-item" href="/PatrickA7" data-ga-click="Header, go to profile, text:your profile">
          Your profile
        </a>
        <a class="dropdown-item" href="/PatrickA7?tab=stars" data-ga-click="Header, go to starred repos, text:your stars">
          Your stars
        </a>
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/logout" class="logout-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="XgyhTpGrYQzJxukIsI+UxShME8pV2GqSZwUErEAYalo8+gfyU7i26Mkx9hKcBDJUITKYWj8VQHbms6x9VPgqpw==" /></div>
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/logout" class="sr-only right-0" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="MR9EOlzzelXfhAIbDHfWOsLVizFNOW9MQ8DkILMrfaJT6eKGnuCtsd9zHQEg/HCry6sAoSf0RajCdkzxp8s9Xw==" /></div>
      <button type="submit" class="dropdown-item dropdown-signout" data-ga-click="Header, sign out, icon:logout">
        Sign out
      </button>
</form>  </div>
...
<div class="pagehead repohead instapaper_ignore readability-menu experiment-repo-nav">
  ...
  <li>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="xlHXjxi1H1QZl7W2pE5n8YUXpPiBcIJnAHQRFS8ZEfqH+3sDGPR98REAcGDvnb+1n8cmzLU6QOqi4avS1yOpNg==" /></div>      <input class="form-control" id="repository_id" name="repository_id" type="hidden" value="1337658" />
  ...
  <li>
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/scottjehl/Respond/unstar" class="starred" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="ck8xMWRffS1Qy8sfWoi3jYw8/6KggszQX0H7KxwIqVl2XTwD421GTfZTSFcGsxONTa+PvG6l3dFF4kitGXnUFg==" /></div>
      <button
        type="submit"
        ...
        <a class="social-count js-social-count" href="/scottjehl/Respond/stargazers"
           aria-label="10747 users starred this repository">
          10,747
        </a>
</form>
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/scottjehl/Respond/star" class="unstarred" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="mXqa/Hcl/q6n3qkB8hhhUW5UwZZ5AVbZhjCqfOQky+XbLxMwDcdj06wyECBtEWDd/RYsaR3CJQpFvKcJRx67FQ==" /></div>
      <button
        type="submit"
        class="btn btn-sm btn-with-count js-toggler-target"
  ...
  <li>
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/scottjehl/Respond/fork" class="btn-with-count" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="sjMQBUvYZfOW+jzdDeXzmFViemd2UX3kYtPcXqCn5j0nUtzt62DVC5cbKIZa0xjrbtrsuuBFcModJ/17MUfqCA==" /></div>
            <button
                type="submit"
    ...
    <a href="/scottjehl/Respond/network" class="social-count"
       aria-label="3591 users forked this repository">
      3,591
    </a>
  </li>
</ul>
...
<div class="select-menu branch-select-menu js-menu-container js-select-menu float-left">
  ...
  <div class="commit-tease">
      <span class="float-right">
        ...
        <relative-time datetime="2015-12-12T15:18:45Z">Dec 13, 2015</relative-time>
      </span>
      <div>
  ...
  <div class="file-actions">
    ...
    <div class="BtnGroup">
      ...
      <a href="/scottjehl/Respond/commits/master/dest/respond.src.js" class="btn btn-sm BtnGroup-item" rel="nofollow">History</a>
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/scottjehl/Respond/edit/master/dest/respond.src.js" class="inline-form js-update-url-with-hash" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="t+jZgNZ+JpH7nlomYFlAqgI/qjK5C2S6XO7teeDaWNwhyTBFbUX6yVKzM1qj0nkIMMn4s8E1AQb86EROYuXQmw==" /></div>
          <button class="btn-octicon tooltipped tooltipped-nw" type="submit"
            aria-label="Fork this project and edit the file" data-hotkey="e" data-disable-with>
            <svg aria-hidden="true" class="octicon octicon-pencil" height="16" version="1.1" viewBox="0 0 14 16" width="14"><path fill-rule="evenodd" d="M0 12v3h3l8-8-3-3-8 8zm3 2H1v-2h1v1h1v1zm10.3-9.3L12 6 9 3l1.3-1.3a.996.996 0 0 1 1.41 0l1.59 1.59c.39.39.39 1.02 0 1.41z"/></svg>
          </button>
</form>        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/scottjehl/Respond/delete/master/dest/respond.src.js" class="inline-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="YLLYqHn1T/6wffhNdYEJ5ssmvNEEeB0hPC06YfDfra9xyCDz0cZrMQfC6oo/gG7bGurt56YJuHIdoIpvLgchgg==" /></div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2017 <span title="0.13182s from github-fe116-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
